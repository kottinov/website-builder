...
class RelIn(BaseModel):
    ...
    left: Optional[int] = Field(
        default=None, description="Left offset from parent left edge."
    )
    top: Optional[int] = Field(
        default=None, description="Top offset from parent top edge."
    )
    right: Optional[int] = Field(
        default=None, description="Right offset from parent right edge."
    )
    bottom: Optional[int] = Field(
        default=None, description="Bottom offset from parent bottom edge."
    )
...
class RelTo(BaseModel):
    ...
    below: Optional[int] = Field(
        default=None, description="Vertical space below target component."
    )
...
class MobileSettings(BaseModel):
    ...
    size: Optional[str] = Field(
        default=None, description="Background/size configuration on mobile."
    )
    columns: Optional[int] = Field(
        default=None, description="Column count for mobile grids/galleries."
    )
    spacingPx: Optional[int] = Field(
        default=None, description="Spacing in px for mobile grids/galleries."
    )
...
class LinkAction(BaseModel):
    ...
    link: PageLink
    openInNewWindow: bool = Field(
        default=False, description="Open link in a new window."
    )
...
class ColorData(BaseModel):
    ...
    gradient: Optional[LooseJSON] = Field(
        default=None, description="Gradient definition."
    )
...
class Asset(BaseModel):
    ...
    animated: Optional[bool] = Field(
        default=None, description="Whether the asset is animated."
    )
    ...
    image: Optional[LooseJSON] = Field(
        default=None, description="Optional embedded image data."
    )
    recommendedFormat: Optional[str] = Field(
        default=None, description="Recommended format."
    )
    url: Optional[str] = Field(
        default=None, description="Repository URL for the asset."
    )
    ...
    isExternalLink: Optional[bool] = Field(
        default=None, description="True when using external/placeholder asset URLs."
    )
...
class AssetData(BaseModel):
    ...
    scrollEffect: Optional[str] = Field(
        default=None, description="Scroll effect, e.g., 'parallax'."
    )
...
class Background(BaseModel):
    ...
    colorData: Optional[ColorData] = Field(
        default=None, description="Solid color or gradient data."
    )
    assetData: Optional[AssetData] = Field(
        default=None, description="Asset-backed background data."
    )
...
class Style(BaseModel):
    ...
    background: Optional[Background] = Field(
        default=None, description="Background settings."
    )
    ...
    text: Optional[Dict[str, LooseJSON]] = Field(
        default=None, description="Text style payload."
    )
...
class CreateInput(BaseModel):
    ...
    # core identity
    kind: str = Field(
        description="WSB component kind identifier (e.g., 'TEXT', 'IMAGE', 'BUTTON')."
    )
    id: Optional[str] = Field(
        default=None,
        description="Optional explicit id; if omitted a UUID is generated.",
    )
    inTemplate: Optional[bool] = Field(
        default=False, description="Set true if component belongs to template."
    )
    orderIndex: Optional[int] = Field(
        default=None,
        description="Sibling order index (automatically set during insert).",
    )
    wrap: Optional[bool] = Field(
        default=False, description="Enable wrapping behavior for container components."
    )
    items: Optional[List[Dict[str, LooseJSON]]] = Field(
        default=None, description="Child components (for containers)."
    )
    ...
    bottom: Optional[int] = Field(
        default=None, description="Bottom position in pixels."
    )
    ...
    relIn: Optional[RelIn] = Field(
        default=None, description="Relative positioning to parent container."
    )
    relTo: Optional[RelTo] = Field(
        default=None, description="Relative positioning to another sibling component."
    )
    relPage: Optional[RelPage] = Field(
        default=None, description="Page-level positioning relation."
    )
    relPara: Optional[RelPara] = Field(
        default=None, description="Paragraph-level positioning relation."
    )
    bbox: Optional[BBox] = Field(
        default=None, description="Bounding box coordinates (bottom, left, right, top)."
    )

    # content/text
    content: Optional[str] = Field(
        default=None, description="HTML content for text components."
    )
    ...
    placeholderText: Optional[str] = Field(
        default=None, description="Alternative placeholder text field."
    )
    paras: Optional[List[LooseJSON]] = Field(
        default=None, description="Paragraph metadata for rich text."
    )
    links: Optional[List[LooseJSON]] = Field(
        default=None, description="Link metadata for text elements."
    )
    globalStyleId: Optional[str] = Field(
        default=None, description="Global style reference id."
    )
    verticalAlignment: Optional[str] = Field(
        default=None, description="Vertical alignment (top, middle, bottom)."
    )
    horizontalAlignment: Optional[str] = Field(
        default=None, description="Horizontal alignment (left, center, right)."
    )
    verticalAlign: Optional[str] = Field(
        default=None, description="Legacy vertical alignment for menu/logo components."
    )
    horizontalAlign: Optional[str] = Field(
        default=None,
        description="Legacy horizontal alignment for menu/logo components.",
    )
    textStyle: Optional[str] = Field(
        default=None, description="Predefined text style identifier."
    )

    # typography & color
    font: Optional[str] = Field(default=None, description="Font family or font index.")
    fontFamily: Optional[str] = Field(
        default=None, description="Explicit font family name."
    )
    fontSize: Optional[int] = Field(
        default=None, description="Font size in pixels or points."
    )
    ...
    letterSpacing: Optional[float] = Field(
        default=None, description="Letter spacing value."
    )
    lineHeight: Optional[float] = Field(
        default=None, description="Line height multiplier."
    )
    color: Optional[str] = Field(default=None, description="Text or foreground color.")
    themeColor: Optional[str] = Field(
        default=None, description="Theme color identifier."
    )
    themeHighlightColor: Optional[str] = Field(
        default=None, description="Theme highlight color."
    )
    themeOverrideColor: Optional[str] = Field(
        default=None, description="Override theme color."
    )
    themeStyle: Optional[str] = Field(
        default=None, description="Theme style identifier."
    )
    themeShadowColor: Optional[str] = Field(
        default=None, description="Theme shadow color."
    )
    themeShadowBlurRadius: Optional[float] = Field(
        default=None, description="Shadow blur radius."
    )
    themeShadowOffsetX: Optional[float] = Field(
        default=None, description="Shadow horizontal offset."
    )
    themeShadowOffsetY: Optional[float] = Field(
        default=None, description="Shadow vertical offset."
    )

    # styling & themes
    style: Optional[Style] = Field(
        default=None, description="CSS-like style properties."
    )
    styles: Optional[List[Union[Style, LooseJSON]]] = Field(
        default=None, description="Array of style definitions."
    )
    styleType: Optional[str] = Field(default=None, description="Style type identifier.")
    buttonThemeSelected: Optional[str] = Field(
        default=None, description="Selected button theme variant."
    )
    fuButtonThemeSelected: Optional[str] = Field(
        default=None, description="File-upload button theme selection."
    )
    ...
    corners: Optional[LooseJSON] = Field(
        default=None, description="Corner radius properties."
    )
    padding: Optional[LooseJSON] = Field(
        default=None, description="Padding properties."
    )
    background: Optional[str] = Field(
        default=None, description="Background color or gradient."
    )
    backgroundColor: Optional[LooseJSON] = Field(
        default=None, description="Background color object/array."
    )
    backgroundSize: Optional[str] = Field(default=None, description="Background size.")
    backgroundRepeat: Optional[str] = Field(
        default=None, description="Background repeat."
    )
    backgroundPosition: Optional[str] = Field(
        default=None, description="Background position."
    )
    backgroundAttachment: Optional[str] = Field(
        default=None, description="Background attachment."
    )
    backgroundClip: Optional[str] = Field(default=None, description="Background clip.")
    gradient: Optional[LooseJSON] = Field(
        default=None, description="Gradient configuration."
    )
    selectedTheme: Optional[str] = Field(
        default=None, description="Selected theme name (e.g., 'Main', 'White', 'Dark')."
    )
    selectedGradientTheme: Optional[str] = Field(
        default=None, description="Selected gradient theme name."
    )
    selectedBorderTheme: Optional[str] = Field(
        default=None, description="Selected border theme name."
    )
    themeColorType: Optional[str] = Field(default=None, description="Theme color type.")
    themeStyles: Optional[ThemeStyles] = Field(
        default=None, description="Theme style references for menus."
    )
    useOriginalColors: Optional[bool] = Field(
        default=None, description="Use original colors for icons/assets."
    )
    colorType: Optional[str] = Field(
        default=None, description="Color type for theme adaptation (LIGHT, DARK)."
    )

    # media & assets
    image: Optional[str] = Field(default=None, description="Image URL or identifier.")
    asset: Optional[Union[str, Asset]] = Field(
        default=None, description="Asset identifier or metadata."
    )
    assetData: Optional[AssetData] = Field(default=None, description="Asset metadata.")
    cropLeft: Optional[float] = Field(
        default=None, description="Image crop left offset."
    )
    cropTop: Optional[float] = Field(default=None, description="Image crop top offset.")
    scaleStrategy: Optional[str] = Field(
        default=None, description="Image scaling strategy."
    )
    lightBoxEnabled: Optional[bool] = Field(
        default=None, description="Enable lightbox for images."
    )
    rawSvg: Optional[str] = Field(default=None, description="Raw SVG markup.")
    svgJson: Optional[LooseJSON] = Field(
        default=None, description="SVG structure as JSON."
    )
    viewBox: Optional[str] = Field(default=None, description="SVG viewBox attribute.")
    defaultFillColor: Optional[str] = Field(
        default=None, description="Default fill color."
    )
    colors: Optional[List[ColorStop]] = Field(
        default=None, description="Color stop definitions."
    )
    logoHorizontalAlignment: Optional[str] = Field(
        default=None, description="Logo alignment in menus."
    )
    logoSize: Optional[str] = Field(default=None, description="Logo size variant.")
    logoTitleScale: Optional[float] = Field(
        default=None, description="Logo title scale factor."
    )

    # links/actions
    link: Optional[str] = Field(default=None, description="Link URL.")
    linkAction: Optional[LinkAction] = Field(
        default=None, description="Link action configuration."
    )
    linkId: Optional[str] = Field(default=None, description="Link target component ID.")
    openInNewWindow: Optional[bool] = Field(
        default=None, description="Open link in new window."
    )
    openLink: Optional[Union[str, bool]] = Field(
        default=None, description="Link opening behavior."
    )
    dialogProps: Optional[Dict[str, LooseJSON]] = Field(
        default=None, description="Dialog properties for widgets (e.g., youtube)."
    )
    state: Optional[WidgetState] = Field(
        default=None, description="Widget state for embedded components."
    )

    # mobile/responsive
    mobileDown: Optional[bool] = Field(
        default=None, description="Push content down on mobile."
    )
    mobileHide: Optional[bool] = Field(
        default=None, description="Hide component on mobile."
    )
    mobileSettings: Optional[MobileSettings] = Field(
        default=None, description="Mobile-specific settings."
    )
    mobileFontSize: Optional[int] = Field(
        default=None, description="Font size for mobile."
    )
    mobileSize: Optional[Union[str, int]] = Field(
        default=None, description="Size configuration for mobile."
    )
    mobileHorizontalAlignment: Optional[str] = Field(
        default=None, description="Horizontal alignment on mobile."
    )
    stretch: Optional[bool] = Field(
        default=None,
        description="Stretch component to fill width (typically for SECTION).",
    )
    ...
    scrollEffect: Optional[str] = Field(
        default=None, description="Scroll-triggered effect."
    )
    hover: Optional[LooseJSON] = Field(
        default=None, description="Hover state properties."
    )
    onHover: Optional[LooseJSON] = Field(default=None, description="On hover behavior.")
    press: Optional[LooseJSON] = Field(
        default=None, description="Press/click state properties."
    )
    onClickAction: Optional[str] = Field(
        default=None, description="Gallery click action."
    )

    # gallery/slider media
    images: Optional[List[GalleryImage]] = Field(
        default=None, description="Gallery images with assets."
    )
    crop: Optional[bool] = Field(
        default=None, description="Whether to crop gallery images."
    )
    captionsEnabled: Optional[bool] = Field(
        default=None, description="Enable captions for gallery."
    )
    captionsAlignment: Optional[str] = Field(
        default=None, description="Caption alignment for gallery."
    )
    columns: Optional[int] = Field(default=None, description="Gallery columns.")
    spacingPx: Optional[int] = Field(
        default=None, description="Gallery spacing in pixels."
    )
    imageStyle: Optional[LooseJSON] = Field(
        default=None, description="Gallery image style overrides."
    )
    captionBoxStyle: Optional[LooseJSON] = Field(
        default=None, description="Gallery caption box style."
    )
    previousCaptionStyle: Optional[str] = Field(
        default=None, description="Previous caption style."
    )
    ...
    captionTitleTextStyle: Optional[LooseJSON] = Field(
        default=None, description="Caption title text style."
    )
    captionDescriptionTextStyle: Optional[LooseJSON] = Field(
        default=None, description="Caption description text style."
    )
    captionMinHeight: Optional[int] = Field(
        default=None, description="Minimum caption height."
    )
    fullWidthOption: Optional[FullWidthOption] = Field(
        default=None, description="Gallery full width option."
    )
    compactView: Optional[bool] = Field(
        default=None, description="Enable compact gallery view."
    )
    captionsPlacement: Optional[str] = Field(
        default=None, description="Placement of captions in gallery/slider."
    )
    ...
    indicator: Optional[str] = Field(
        default=None, description="Indicator style for slideshows."
    )
    navigator: Optional[str] = Field(
        default=None, description="Navigator visibility for slideshows."
    )
    transition: Optional[str] = Field(
        default=None, description="Transition type for slideshows."
    )
    originalSize: Optional[bool] = Field(
        default=None, description="Show media in original size."
    )
    columnCount: Optional[int] = Field(
        default=None, description="Column count for sliders/grids."
    )
    showBackground: Optional[bool] = Field(
        default=None, description="Show background behind media."
    )
    ...
    size: Optional[Union[str, int]] = Field(
        default=None, description="Size configuration."
    )
    position: Optional[str] = Field(
        default=None, description="Position type (absolute, relative, etc)."
    )
    ...
    pin: Optional[int] = Field(
        default=None, description="Pin component position (0 for unpinned)."
    )

    # address/map
    addressLocation: Optional[AddressLocation] = Field(
        default=None, description="Geolocation for map/address components."
    )
    addressText: Optional[str] = Field(
        default=None, description="Address display text."
    )
    ...
    # forms/contact
    captchaLang: Optional[str] = Field(
        default=None, description="Captcha language code."
    )
    formElements: Optional[Dict[str, FormElement]] = Field(
        default=None, description="Form field definitions keyed by field name."
    )
    formElementsOrder: Optional[List[str]] = Field(
        default=None, description="Order of form fields."
    )
    styleForm: Optional[StyleForm] = Field(
        default=None, description="Form style definition."
    )
    styleButton: Optional[Style] = Field(
        default=None, description="Button style reference."
    )
    fileUploadButtonStyle: Optional[Style] = Field(
        default=None, description="File upload button style reference."
    )
    submitBtn: Optional[str] = Field(default=None, description="Submit button label.")
    successMessage: Optional[str] = Field(
        default=None, description="Success message after form submit."
    )
    isCaptchaEnabled: Optional[bool] = Field(
        default=None, description="Enable captcha for forms."
    )
    isMarketingConsentEnabled: Optional[bool] = Field(
        default=None, description="Require marketing consent."
    )
    marketingConsentCheckBoxText: Optional[str] = Field(
        default=None, description="Marketing consent checkbox text."
    )
    readPrivacyPolicyText: Optional[str] = Field(
        default=None, description="Privacy policy link text."
    )
    recipientEmail: Optional[str] = Field(
        default=None, description="Form recipient email."
    )
    subject: Optional[str] = Field(default=None, description="Form subject line.")

    # menu/social/embed
    layoutType: Optional[str] = Field(
        default=None, description="Layout type identifier."
    )
    startLevel: Optional[int] = Field(default=None, description="Menu start level.")
    moreButtonEnabled: Optional[bool] = Field(
        default=None, description="Enable more button in menu."
    )
    moreText: Optional[str] = Field(default=None, description="More button text.")
    isStickyToHeader: Optional[bool] = Field(
        default=None, description="Stick component to header."
    )
    theme: Optional[str] = Field(default=None, description="Embed theme.")
    doNotTrack: Optional[bool] = Field(
        default=None, description="Disable tracking for embeds."
    )
    direction: Optional[str] = Field(
        default=None, description="Text direction for embeds."
    )
    pageURL: Optional[str] = Field(default=None, description="Social/embed page URL.")
    tabs: Optional[List[str]] = Field(
        default=None, description="Tabs for social embeds."
    )
    hideCover: Optional[bool] = Field(default=None, description="Hide cover image.")
    showFacepile: Optional[bool] = Field(
        default=None, description="Show facepile in embeds."
    )
    showCTA: Optional[bool] = Field(
        default=None, description="Show call-to-action in embeds."
    )
    smallHeader: Optional[bool] = Field(
        default=None, description="Use small header in embeds."
    )
    adaptContainerWidth: Optional[bool] = Field(
        default=None, description="Adapt container width for embeds."
    )
    timelineLink: Optional[str] = Field(
        default=None, description="Twitter timeline link."
    )
    ...
    isDecorative: Optional[bool] = Field(
        default=None, description="Mark element as decorative."
    )

    # data/table
    cells: Optional[List[LooseJSON]] = Field(
        default=None, description="Table/gallery cells data."
    )
    commonCellsData: Optional[Dict[str, LooseJSON]] = Field(
        default=None, description="Shared cell data for grids/tables."
    )

    # misc props
    generic: Optional[GenericInfo] = Field(
        default=None, description="Generic info block settings."
    )
    specific: Optional[SpecificInfo] = Field(
        default=None, description="Specific info block settings."
    )
    modernLayout: Optional[LooseJSON] = Field(
        default=None, description="Modern layout payload for sections."
    )
    modernLayoutOptions: Optional[LooseJSON] = Field(
        default=None, description="Modern layout options for eligible components."
    )
    code: Optional[str] = Field(
        default=None, description="Custom code content for CODE components."
    )
    location: Optional[str] = Field(
        default=None, description="Insert location for CODE components."
    )
    textStyleMeta: Optional[Dict[str, LooseJSON]] = Field(
        default=None, description="Text style metadata for components like BOOKINGS."
    )
    ...
    def _validate_create_input(self) -> "CreateInput":
        ...
        if self.relIn is not None:
            rel_offsets = [
                getattr(self.relIn, key) for key in ("left", "top", "right", "bottom")
            ]
...
OperationPayload = Annotated[
    ...
    Field(
        discriminator="op",
        description="Batch operation payload with discriminated union on 'op' field",
    ),
]
